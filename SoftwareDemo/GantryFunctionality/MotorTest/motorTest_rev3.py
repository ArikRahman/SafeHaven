...
pulY.pulse(fade_in_time=0.5, fade_out_time=0.5, n= 10, background=False) # Start PWM signal

print("Starting X-axis CW rotation...")
dirX.off() # Set direction to CW
pulX.pulse(fade_in_time=0.5, fade_out_time=0.5, n= 10, background=False) # Start PWM signal
