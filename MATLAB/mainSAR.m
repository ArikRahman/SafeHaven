...
z0 = 323e-3;        % Range of target (range of corresponding image slice)
dx = 290/400;       % Sampling distance at x (horizontal) axis in mm
dy = 205/100;             % Sampling distance at y (vertical) axis in mm
